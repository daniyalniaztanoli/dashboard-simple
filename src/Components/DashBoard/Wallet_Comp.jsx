  ...
  return (
    ...
    <ul className='h-screen space-y-6 ms-10 text-start w-full'>
           ...
           <li className='mb-5  font-bold text-xl hover:text-gray-600 cursor-pointer'><Link to='/food'>Foods</Link></li>
            ...
            <li className='mb-5 text-white font-bold text-xl hover:text-gray-600 cursor-pointer bg-green-600 p-2 w-32 rounded'><Link to='/wallet'>Wallet</Link></li>
        </ul>
  </div>
  <div className='w-[80%] bg-green-300'>
   <h1 className='text-dark font-mono font-bold text-4xl flex justify-center h-56 items-center'>Wallet Section</h1>
  </div>
    </div>
