...
const Customer_Comp = () => {
  return (
    ...
    <ul className='h-screen space-y-6 ms-10 text-start w-full'>
            ...
            <li className='mb-5 font-bold text-xl hover:text-gray-600 cursor-pointer bg-green-600 text-white p-2 w-32 rounded'><Link to='/customer'> Customer </Link></li>
